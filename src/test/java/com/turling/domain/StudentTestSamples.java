...
public class StudentTestSamples {
    ...
    public static Student getStudentSample1() {
        return new Student().id(1L).name("name1").gender("gender1").contactNumber("contactNumber1").parentsName("parentsName1");
    }

    public static Student getStudentSample2() {
        return new Student().id(2L).name("name2").gender("gender2").contactNumber("contactNumber2").parentsName("parentsName2");
    }
    ...
    public static Student getStudentRandomSampleGenerator() {
        return new Student()
            ...
            .parentsName(UUID.randomUUID().toString());
    }
}
