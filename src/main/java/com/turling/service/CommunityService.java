...
/**
 * Service Interface for managing {@link com.turling.domain.Community}.
 */
public interface CommunityService {
    ...
    /**
     * Get all the communities with eager load of many-to-many relationships.
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    Page<CommunityDTO> findAllWithEagerRelationships(Pageable pageable);
