...
import com.turling.service.StudentQueryService;
...
/**
 * REST controller for managing {@link com.turling.domain.Student}.
 */
@RestController
...
public class StudentResource {
    ...
    public ResponseEntity<StudentDTO> createStudent(@RequestBody StudentDTO studentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/students/" + studentDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, studentDTO.getId().toString()))
            .body(studentDTO);
    }
