...
interface QuestionDescImageUploadProps {
...
const QuestionDescImageUpload: React.FC<QuestionDescImageUploadProps> = ({ onUploadSuccess, disabled = false }) => {
      ...
      image.onload = () => {
        ...
        canvas.toBlob(
          async blob => {
            ...
            // Create FormData for upload with specific parameters for question description
            const formData = new FormData();
            formData.append('file', blob, 'question-desc-image.png');
            formData.append('folder', 'question_desc');
            formData.append('filename', uuidv4());
            formData.append('bizType', 'question_desc');
...
export default QuestionDescImageUpload;
