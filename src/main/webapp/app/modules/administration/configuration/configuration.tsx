...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>过滤 (按前缀)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>前缀</th>
            <th onClick={changeReverseProperties}>属性</th>
          </tr>
        </thead>
        <tbody>
