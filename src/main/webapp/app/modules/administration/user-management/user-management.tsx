      ...
      <h2 id="user-management-page-heading" data-cy="userManagementPageHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="new" className="btn btn-primary jh-create-entity">
            <FontAwesomeIcon icon="plus" /> 创建新用户
          </Link>
        </div>
      </h2>
        ...
        <thead>
          <tr>
            ...
            <th className="hand" onClick={sort('login')}>
              登录 <FontAwesomeIcon icon={getSortIconByFieldName('login')} />
            </th>
            <th className="hand" onClick={sort('email')}>
              邮箱 <FontAwesomeIcon icon={getSortIconByFieldName('email')} />
            </th>
            <th />
            <th>角色</th>
            <th className="hand" onClick={sort('createdDate')}>
              创建时间 <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
            </th>
            <th className="hand" onClick={sort('lastModifiedBy')}>
              最近修改人 <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
            </th>
            <th id="modified-date-sort" className="hand" onClick={sort('lastModifiedDate')}>
              最近修改时间 <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
            </th>
            <th />
          </tr>
        </thead>
