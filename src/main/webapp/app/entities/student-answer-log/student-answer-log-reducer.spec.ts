...
import reducer, { getEntities, getEntity, reset } from './student-answer-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTANSWERLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTANSWERLOG actions', async () => {
      const arg = 42666;
