...
import reducer, {
  ...
  reset,
  updateEntity,
} from './question-base-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONBASEGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUESTIONBASEGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUESTIONBASEGROUP actions', async () => {
      const arg = { id: 23739 };
    ...
    it('dispatches UPDATE_QUESTIONBASEGROUP actions', async () => {
      const arg = { id: 23739 };
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONBASEGROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUESTIONBASEGROUP actions', async () => {
      const arg = 42666;
