...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONOPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUESTIONOPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUESTIONOPTION actions', async () => {
      const arg = { id: 15943 };
    ...
    it('dispatches UPDATE_QUESTIONOPTION actions', async () => {
      const arg = { id: 15943 };
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONOPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUESTIONOPTION actions', async () => {
      const arg = 42666;
