...
import reducer, {
  ...
  reset,
  updateEntity,
} from './question-section-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONSECTIONGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUESTIONSECTIONGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUESTIONSECTIONGROUP actions', async () => {
      const arg = { id: 9699 };
    ...
    it('dispatches UPDATE_QUESTIONSECTIONGROUP actions', async () => {
      const arg = { id: 9699 };
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONSECTIONGROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUESTIONSECTIONGROUP actions', async () => {
      const arg = 42666;
