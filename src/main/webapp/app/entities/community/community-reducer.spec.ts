...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './community.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMUNITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMUNITY actions', async () => {
      const arg = { id: 25732 };
    ...
    it('dispatches UPDATE_COMMUNITY actions', async () => {
      const arg = { id: 25732 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMUNITY actions', async () => {
      const arg = 42666;
