...
import reducer, {
  ...
  reset,
  updateEntity,
} from './student-section-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTSECTIONLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTSECTIONLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTSECTIONLOG actions', async () => {
      const arg = { id: 5068 };
    ...
    it('dispatches UPDATE_STUDENTSECTIONLOG actions', async () => {
      const arg = { id: 5068 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTSECTIONLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTSECTIONLOG actions', async () => {
      const arg = 42666;
