...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './distinct.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTINCT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISTINCT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISTINCT actions', async () => {
      const arg = { id: 5526 };
    ...
    it('dispatches UPDATE_DISTINCT actions', async () => {
      const arg = { id: 5526 };
    ...
    it('dispatches PARTIAL_UPDATE_DISTINCT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISTINCT actions', async () => {
      const arg = 42666;
