...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './school.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHOOL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHOOL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHOOL actions', async () => {
      const arg = { id: 6541 };
    ...
    it('dispatches UPDATE_SCHOOL actions', async () => {
      const arg = { id: 6541 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHOOL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHOOL actions', async () => {
      const arg = 42666;
