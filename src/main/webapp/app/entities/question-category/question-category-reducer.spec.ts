...
import reducer, {
  ...
  reset,
  updateEntity,
} from './question-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUESTIONCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUESTIONCATEGORY actions', async () => {
      const arg = { id: 20364 };
    ...
    it('dispatches UPDATE_QUESTIONCATEGORY actions', async () => {
      const arg = { id: 20364 };
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUESTIONCATEGORY actions', async () => {
      const arg = 42666;
