...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTGRADE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTGRADE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTGRADE actions', async () => {
      const arg = { id: 21076 };
    ...
    it('dispatches UPDATE_STUDENTGRADE actions', async () => {
      const arg = { id: 21076 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTGRADE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTGRADE actions', async () => {
      const arg = 42666;
